...
Give output in the form of a JSON array with the schema {"id": int, "subject": string}. Something like {"alternates": [{"id": 1, "subject": <SUBJECT>}, {"id": 2, "subject": <SUBJECT>}, {"id": 3, "subject": <SUBJECT>}]}
...
Output: {"alternates": [{"id": 1, "subject": "Data Structures"}, {"id": 2, "subject": "Computer Architecture"}, {"id": 3, "subject": "Object Oriented Programming"}]}

2. Input: "Topic: Maths"
Output: {"alternates": [{"id": 1, "subject": "Linear Algebra"}, {"id": 2, "subject": "Calculus"}, {"id": 3, "subject": "Probability and Statistics"}]}

3. Input: "Topic: White"
Output: {"alternates": [{"id": 1, "subject": "Color Theory"}, {"id": 2, "subject": "Digital Image Processing"}, {"id": 3, "subject": "History of Pigments and Paints"}]}

4. Input: "Topic: bracelet"
Output: { "alternates": [{ "id": 1, "subject": "Material Science" }, {"id": 2, "subject": "3D Modeling and Design"}, {"id": 3, "subject": "Jewelry Design Principles" }]}

5. Input: "Topic: bark"
Output: {"alternates": [{"id": 1, "subject": "Plant Biology"}, {"id": 2, "subject": "Forest Ecology"}, {"id": 3, "subject": "Dendrology"}]}
`
